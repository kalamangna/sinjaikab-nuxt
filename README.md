...
- **Aksesibilitas & SEO**: Standar WCAG 2.1 AA (Skip to Content, Kontras Tinggi AAA, Semantik Penuh, UserWay On-Demand), Schema.org JSON-LD, Open Graph, dan HTTP Security Headers.
