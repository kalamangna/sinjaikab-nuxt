...
- Penyederhanaan tombol aksi pratinjau dokumen ([`pages/informasi/[slug].vue`](./pages/informasi/[slug].vue)): merapikan tombol-tombol duplikat dengan menghapus tombol tautan di header kartu pratinjau dan menyisakan satu tombol aksi tunggal *"Tampilkan Pratinjau Dokumen"* pada placeholder berkas Google Drive sehingga antarmuka lebih bersih dan terfokus.
