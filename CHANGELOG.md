...
- Penyederhanaan Meta Title & Meta Description SEO ([`app.vue`](./app.vue), [`pages/informasi/index.vue`](./pages/informasi/index.vue), dan [`pages/informasi/[slug].vue`](./pages/informasi/[slug].vue)):
  ...
  - **Daftar Informasi Publik ([`pages/informasi/index.vue`](./pages/informasi/index.vue))**: Menyederhanakan format `pageTitle` dan `pageDescription` menjadi ringkas tanpa narasi panjang atau frasa berulang (`"Layanan Informasi Publik Pemerintah Kabupaten Sinjai."`, `"Hasil pencarian dokumen \"...\" Pemerintah Kabupaten Sinjai."`, dan `"Daftar dokumen ... Pemerintah Kabupaten Sinjai."`).
